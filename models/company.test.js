// a test suite for the Company class, which tests various methods of the class against the database. 
// ensuring that they interact correctly with the database and handle different scenarios and error cases appropriately.
// import hooks are used to set up and tear down the test environment. 
...
describe("findAll", function () {
  ...
  test("bad request if invalid minEmployees > maxEmployees", async function () {
    try {
